            ...
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('siswa/save', array('id'=>'siswa'), array('method'=>'edit', 'id_siswa'=>$siswa->id_siswa))?>
                    <div class="form-group">
                        <label for="nomor_induk">NomorInduk</label>
                        <input value="<?=$siswa->nomor_induk?>" autofocus="autofocus" onfocus="this.select()" placeholder="Nomor Induk" type="text" name="nomor_induk" class="form-control">
