                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <select name="id_hambatan" required="required" id="id_hambatan" class="select2 form-group" style="width:100% !important">
                                <option value="" disabled selected>Pilih Hambatan Belajar</option>
                                <?php foreach ($learningObstacle as $lo) : ?>
                                    <option value="<?= $lo->id ?>"><?= $lo->lo; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <small class="help-block" style="color: #dc3545"><?=form_error('id_hambatan')?></small>
                        </div>
