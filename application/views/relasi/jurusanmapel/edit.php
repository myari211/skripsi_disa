    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                    <?=form_open('jurusanmapel/save', array('id'=>'jurusanmapel'), array('method'=>'edit', 'mapel_id'=>$id_mapel))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/jurusanmapel/edit.js"></script>