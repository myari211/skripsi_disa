        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="jumlah_soal" class="form-control" value="<?=$jml; ?>">
                    <input type="text" readonly="readonly" class="form-control" value="<?= $jml; ?>">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="jenis">Tampilan Soal</label>
                        <input type="hidden" name="jenis" class="form-control" value="urut">
                        <input type="text" readonly="readonly" class="form-control" value="Secara Terurut">
                    <small class="help-block"></small>
                </div>
