...
class Soal extends CI_Controller {
    ...
    public function index()
	{
        ...
        if($this->ion_auth->is_admin()){
            ...
            $data['soal'] = $this->soal->getAllHambatanBelajar();
        }else{
    ...
    public function add()
	{
        ...
        if($this->ion_auth->is_admin()){
            ...
            $data['learningObstacle'] = $this->soal->getAllHambatanBelajar();
        }else{
            //Jika bukan maka mapel dipilih otomatis sesuai mapel guru
	...
	public function data($id=null, $guru=null, $lo=null)
	{
		$this->output_json($this->soal->getDataSoal($id, $guru, $lo), false);
    }
    ...
    public function validasi()
    {
        if($this->ion_auth->is_admin()){
            ...
            $this->form_validation->set_rules('id_hambatan', 'Hambatan Belajar', 'required');
        }
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            if($this->ion_auth->is_admin()){
                ...
                $data['id_hambatan'] = $this->input->post('id_hambatan', true);
            }else{
